...
router.get('/fetchUserQueries/:page?', rbacMiddleware.checkPermission('fetch_user_queries'), expertController.fetchUnansweredUserQueries);
router.get('/fetchAnsweredUserQueries/:page?', rbacMiddleware.checkPermission('fetch_answered_user_queries'), expertController.fetchAnsweredUserQueries);
